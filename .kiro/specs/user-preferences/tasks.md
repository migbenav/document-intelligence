...
- [x] 1. Create preferences Zustand store with localStorage persistence
  - [x] 1.1 Create usePreferencesStore
  ...
  - [x] 1.2 Write unit tests for preferencesStore
...
- [x] 2. Wire language from preferences store to TranslationProvider
  - [x] 2.1 Update main.tsx with reactive locale
  ...
  - [x] 2.2 Update TranslationProvider default locale
...
- [x] 3. Add i18n keys for sidebar and preferences
  - [x] 3.1 Update Spanish translations
...
- [x] 4. Create Sidebar component
  ...
  - [x] 4.2 Implement responsive behavior
  ...
  - [x] 4.4 Write component tests for Sidebar
...
- [x] 5. Update AppShell layout to include Sidebar
  - [x] 5.1 Modify AppShell layout
...
- [x] 6. Inject preference headers into API client
  - [x] 6.1 Modify API client
  ...
  - [x] 6.2 Write unit test for header injection
...
- [x] 7. Create backend request preferences dependency
  - [x] 7.1 Create preferences module
  ...
  - [x] 7.2 Write unit tests for preferences middleware
...
- [x] 8. Update LLMClient to accept model override and fallback control
  - [x] 8.1 Extend LLMClient.call() signature
  ...
  - [x] 8.2 Write unit tests for new LLMClient parameters
...
- [x] 9. Update base analysis prompts with language parameter
  - [x] 9.1 Modify prompt template
  ...
  - [x] 9.2 Modify LLMAnalyzer to accept language
  ...
  - [x] 9.3 Propagate language through BaseAnalysisService
  ...
  - [x] 9.4 Inject preferences into card and documents API endpoints
...
- [x] 10. Update quality analysis prompts with language parameter
  - [x] 10.1 Update ambiguity detector
  ...
  - [x] 10.5 Propagate language through quality service and API
...
- [x] 11. Update query/Q&A prompts with language parameter
  - [x] 11.1 Update query service
  ...
  - [x] 11.2 Inject preferences into query API endpoint
